...
//         $('.add-module').slideToggle(400);
//         console.log("test");
//         });
//       console.log("test2");
//       };
//   $(document).ready(hoofd());
//
// });
...
$(document).ready(function() {
  var todoModule = (function () {
    ...
    function addTodoFromInput() {
      ...
      var desc = $(".add-desc-input").prop('value');
      var dueDate = $(".add-date-input").prop('value');
      var labels = $(".add-label-input").prop('value');
      var notes = $(".add-notes-input").prop('value');
      var priority = $(".add-priority-input").prop('value');
    ...
    $('.add-module').hide();
    $('.add-btn').click(toggleAddModule());
    $('.finish-add-btn').click(addTodoFromInput);
    console.log("test2");
